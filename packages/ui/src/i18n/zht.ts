...
export const dict = {
  ...
  "ui.tool.mediaGenerateImage": "產生圖片",
  "ui.tool.mediaGenerateVideo": "產生影片",
  "ui.tool.mediaProcess": "處理媒體",
  "ui.media.regenerate.open": "重新生成片段",
  "ui.media.regenerate.duration": "已選 {{duration}} 秒",
  "ui.media.regenerate.preview": "預覽選段",
  "ui.media.regenerate.placeholder": "描述這一段要改成什麼效果…",
  "ui.media.regenerate.cancel": "取消",
  "ui.media.regenerate.submit": "填入輸入框",
  "ui.media.regenerate.error": "無法定位該媒體資產",
  "ui.fileMedia.kind.video": "影片",
