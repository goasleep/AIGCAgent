...
export const dict = {
  ...
  "ui.tool.mediaGenerateImage": "生成图片",
  "ui.tool.mediaGenerateVideo": "生成视频",
  "ui.tool.mediaProcess": "处理媒体",
  "ui.media.regenerate.open": "重生成片段",
  "ui.media.regenerate.duration": "已选 {{duration}} 秒",
  "ui.media.regenerate.preview": "预览选段",
  "ui.media.regenerate.placeholder": "描述这一段要改成什么效果…",
  "ui.media.regenerate.cancel": "取消",
  "ui.media.regenerate.submit": "填入输入框",
  "ui.media.regenerate.error": "无法定位该媒体资产",
  "ui.fileMedia.kind.video": "视频",
