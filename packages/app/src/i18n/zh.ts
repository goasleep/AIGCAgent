...
export const dict = {
  ...
  "settings.media.description": "配置图片和视频生成服务商及模型。也可以通过环境变量提供配置。",
  "settings.media.type": "媒体类型",
  "settings.media.type.image": "图片",
  "settings.media.type.video": "视频",
  "settings.media.provider": "服务商",
  "settings.media.model": "默认模型",
  "settings.media.imageModel": "默认图片模型",
  "settings.media.videoModel": "默认视频模型",
  "settings.media.loading": "正在读取已保存的媒体设置…",
  "settings.media.retry": "重试",
  "settings.media.saved": "媒体设置已保存",
  "settings.media.apiUrl": "{{provider}} API 地址",
  "settings.media.openai.compatibleHint": "可选。输入兼容 OpenAI 接口的基础地址，即可使用兼容的图片服务。",
  "settings.media.apiKey": "{{provider}} API 密钥",
  "settings.media.key.configured": "已配置",
  "settings.media.key.missing": "未配置",
  "settings.media.key.pending": "密钥待保存",
  "settings.media.key.savedHint": "此服务器已保存密钥。输入新密钥可替换，留空则保留原密钥。",
  "settings.media.key.emptyHint": "此处尚未保存密钥，仍可通过环境变量配置。",
  "settings.media.error.load": "无法读取已保存的媒体设置，请重试后再修改。",
  "settings.media.error.save": "媒体设置保存失败，已保留你的修改，请重试。",
  "settings.media.error.verify": "保存后服务器没有持久化全部媒体设置。使用 OpenAI 兼容地址前，请先更新服务器后重试。",
  ...
  "media.title": "媒体库",
  "media.filter.all": "全部",
  "media.filter.image": "图片",
  "media.filter.video": "视频",
  "media.selected": "已选 {{count}} 项",
  "media.use.selected": "发送到会话",
  "media.use.prompt": "请使用以下媒体产物：",
  "media.generate.open": "生成",
  "media.generate.placeholder": "描述你想要生成的图片或视频…",
  "media.generate.size": "尺寸",
  "media.generate.quality": "质量",
  "media.generate.duration": "时长",
  "media.generate.ratio": "比例",
  "media.generate.estimate": "预估费用 {{cost}}",
  "media.stats.assets": "{{count}} 个素材",
  "media.stats.cost": "累计预估费用 {{cost}}",
  "media.generate.submit": "生成",
  ...
  "media.generate.model": "模型",
  "media.generate.model.default": "默认（跟随设置）",
  "media.generate.model.suffix": "，使用模型 {{model}}",
  "media.task.kind.image": "图片生成",
  "media.task.kind.video": "视频生成",
  "media.task.kind.process": "加工处理",
  "media.task.fallback": "媒体任务",
  "media.task.cancel": "取消",
  "media.task.cancel.failed": "取消任务失败。",
  "media.task.done": "已完成",
  "media.task.failed": "失败",
  "media.task.cancelled": "已取消",
  "media.delete.confirm": "删除 {{count}} 个媒体资产？磁盘上的文件也会被删除。",
  "media.empty": "还没有媒体产物。生成一个，或让 agent 帮你创建。",
  "media.load.more": "加载更多",
  "media.load.error": "媒体库加载失败。",
