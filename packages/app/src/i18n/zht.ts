...
export const dict = {
  ...
  "settings.media.title": "媒體生成",
  "settings.media.description": "設定圖片和影片生成服務商及模型。也可以透過環境變數提供設定。",
  "settings.media.type": "媒體類型",
  "settings.media.type.image": "圖片",
  "settings.media.type.video": "影片",
  "settings.media.provider": "服務商",
  "settings.media.model": "預設模型",
  "settings.media.imageModel": "預設圖片模型",
  "settings.media.videoModel": "預設影片模型",
  "settings.media.loading": "正在讀取已儲存的媒體設定…",
  "settings.media.retry": "重試",
  "settings.media.saved": "媒體設定已儲存",
  "settings.media.apiUrl": "{{provider}} API 網址",
  "settings.media.openai.compatibleHint": "可選。輸入相容 OpenAI 介面的基礎網址，即可使用相容的圖片服務。",
  "settings.media.apiKey": "{{provider}} API 金鑰",
  "settings.media.key.configured": "已設定",
  "settings.media.key.missing": "未設定",
  "settings.media.key.pending": "金鑰尚未儲存",
  "settings.media.key.savedHint": "此伺服器已儲存金鑰。輸入新金鑰可替換，留空則保留原金鑰。",
  "settings.media.key.emptyHint": "此處尚未儲存金鑰，仍可透過環境變數設定。",
  "settings.media.error.load": "無法讀取已儲存的媒體設定，請重試後再修改。",
  "settings.media.error.save": "媒體設定儲存失敗，已保留你的修改，請重試。",
  "settings.media.error.verify": "儲存後伺服器沒有持久化全部媒體設定。使用 OpenAI 相容網址前，請先更新伺服器後重試。",
  ...
  "media.title": "媒體庫",
  "media.filter.all": "全部",
  "media.filter.image": "圖片",
  "media.filter.video": "影片",
  "media.selected": "已選 {{count}} 項",
  "media.use.selected": "傳送到工作階段",
  "media.use.prompt": "请使用以下媒体产物：",
  "media.generate.open": "產生",
  "media.generate.placeholder": "描述你想要產生的圖片或影片…",
  "media.generate.size": "尺寸",
  "media.generate.quality": "品質",
  "media.generate.duration": "時長",
  "media.generate.ratio": "比例",
  "media.generate.estimate": "預估費用 {{cost}}",
  "media.stats.assets": "{{count}} 個素材",
  "media.stats.cost": "累計預估費用 {{cost}}",
  "media.generate.submit": "產生",
  ...
  "media.delete.confirm": "刪除 {{count}} 個媒體資產？磁碟上的檔案也會被刪除。",
  "media.empty": "還沒有媒体產物。產生一個，或讓 agent 幫你建立。",
  "media.load.more": "載入更多",
  "media.load.error": "媒體庫載入失敗。",
