...
export const dict = {
  ...
  "settings.media.description":
    "Configure image and video generation providers and models. Environment variables remain supported as fallback.",
  "settings.media.type": "Media type",
  "settings.media.type.image": "Image",
  "settings.media.type.video": "Video",
  "settings.media.provider": "Provider",
  "settings.media.model": "Default model",
  "settings.media.imageModel": "Default image model",
  "settings.media.videoModel": "Default video model",
  "settings.media.loading": "Loading saved media settings…",
  "settings.media.retry": "Retry",
  "settings.media.saved": "Media settings saved",
  "settings.media.apiUrl": "{{provider}} API URL",
  "settings.media.openai.compatibleHint":
    "Optional. Enter an OpenAI-compatible base URL to use a compatible image service.",
  "settings.media.apiKey": "{{provider}} API Key",
  "settings.media.key.configured": "Configured",
  "settings.media.key.missing": "Not configured",
  "settings.media.key.pending": "Unsaved key",
  "settings.media.key.savedHint":
    "A key is saved on this server. Enter a new key to replace it; leave blank to keep it.",
  "settings.media.key.emptyHint": "No key is saved here. Environment variables can still be used.",
  "settings.media.error.load": "Could not load saved media settings. Retry before making changes.",
  "settings.media.error.save": "Failed to save media settings. Your edits are kept; please retry.",
  "settings.media.error.verify":
    "The server did not persist all media settings after saving. Your server may need to be updated before using OpenAI-compatible URLs.",
  ...
  "media.filter.image": "Images",
  "media.filter.video": "Videos",
  "media.selected": "{{count}} selected",
  "media.use.selected": "Send to session",
  "media.use.prompt": "请使用以下媒体产物：",
  "media.generate.open": "Generate",
  "media.generate.placeholder": "Describe the image or video you want to generate…",
  "media.generate.size": "Size",
  "media.generate.quality": "Quality",
  "media.generate.duration": "Duration",
  "media.generate.ratio": "Ratio",
  "media.generate.estimate": "Estimated cost {{cost}}",
  "media.stats.assets": "{{count}} assets",
  "media.stats.cost": "Estimated total {{cost}}",
  "media.generate.submit": "Generate",
  "media.generate.image.prompt": "请生成图片：「{{prompt}}」（size={{size}}, quality={{quality}}）",
  "media.generate.video.prompt": "请生成视频：「{{prompt}}」（duration={{duration}}s, ratio={{ratio}}）",
  "media.generate.model": "Model",
  "media.generate.model.default": "Default (from settings)",
  "media.generate.model.suffix": "，使用模型 {{model}}",
  "media.task.kind.image": "Image generation",
  "media.task.kind.video": "Video generation",
  "media.task.kind.process": "Processing",
  "media.task.fallback": "Media task",
  "media.task.cancel": "Cancel",
  "media.task.cancel.failed": "Failed to cancel the task.",
  "media.task.done": "Done",
  "media.task.failed": "Failed",
  "media.task.cancelled": "Cancelled",
  "media.delete.confirm": "Delete {{count}} media asset(s)? This also deletes the files on disk.",
  "media.empty": "No media yet. Generate something or ask the agent to create it.",
  "media.load.more": "Load more",
  "media.load.error": "Failed to load the media library.",
}
